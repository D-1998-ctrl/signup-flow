...
const SignUp = ({ handleSignupPage }) => {
  ...
  const adminalldata = () => {
    ...
    fetch("http://127.0.0.1:8080/admin/adminsignup/", requestOptions)
  ...
  const newUser = () => {
    ...
    fetch("http://127.0.0.1:8080/common/login/signup", requestOptions)
      .then((response) => response.text())
      .then((result) => console.log(result))
      .catch((error) => console.error(error));
  };
                ...
                <div className="container" >
                  ...
                  <div className="form-group">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', marginTop: '10px' }}>
                      ...
                      <label htmlFor="terms" style={{ color: '#696969', fontSize: '14px', marginBottom: '0' }}>I agree to the terms and conditions </label>
                    </div>

                    

                    <button className="btn1" onClick={createAccount} style={{margin:'15px 0'}}>Create Account</button>
              ...
              <div className=" col-12 case2">
                <div className="container">
                  ...
                  <div style={{ marginTop: "5%" , display:'flex', gap:'10px', justifyContent:'center', alignItems:'center'}}>
                    ...
                    <button  className="btn1" onClick={resensotp}>Resend code</button>{" "}
                  </div>
          ...
          <>
            ...
            <div className=" col-12 case4">
              <div className="container">
                ...
                <button className="btn1" onClick={submitFerminfo} style={{margin:'10px 0'}}>Next</button>
              </div>
            </div>
            <br />
            ...
            <div className="case5">
              ...
              <div className=" col-12 case5">
                <div className="container selection">
                  ...
                  <button className="btn1" onClick={submitFirmDetail}>Next</button>
                </div>
              </div>
            </div>
            ...
            <div className=" col-12 case6">
              ...
              <button className="btn1" onClick={() => handleButtonClick2("TaxPreparation")} style={{ backgroundColor: buttonStates2.TaxPreparation ? "#043a77" : "#3498db" ,margin:'5px 20px'}}>
                ...
                <div>
                  ...
                  <button onClick={submitService} className="btn1" style={{marginLeft:'20px'}}>Next</button>
                </div>
              </div>
            </div>
...
//                     <p className="sign-in-link">
//                       Already have an account?{" "}
//                       <button style={{ background: "none", color: "blue" }} onClick={handleSignupPage}>
//                         Sign in
//                       </button>
