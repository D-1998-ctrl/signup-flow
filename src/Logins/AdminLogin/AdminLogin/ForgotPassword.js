                ...
                <div className='password-container col-6' style={{ height: '50vh', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.5)' }} >
                    <div className='password-info col-12'>
                        ...
                        <div className='pswd-input col-12' style={{ margin: '3% 0 0 5%' }}>
                            ...
                            <input className='col-9' type='email' value={inpval.email} onChange={setVal}  name="email" id="email" placeholder='Email Address'
                                style={{ padding:'8px 12px', borderRadius: '10px', margin: '2% 0 0 0', border: '2px solid rgb(58,145,245)', fontSize: '13px' }} />
                        </div>
                        <div className='reset-button col-5' style={{ margin: '3% 0 1% 5%', display: 'flex', gap: '20px' }}>
                            
                            <button type='submit' onClick={getresetlink} className='btn1 col-5' >Get Reset Link</button>
                            <div>
                                <NavLink to='/' >
                                  
                                <button type='submit' className=' btn2 col-12' >Back to Login</button>  {/* <button type='submit' className='col-12' style={{ padding: '8px 12px', borderRadius: '10px', cursor: 'pointer', fontSize: '14px', color: 'rgb(58, 145, 245)', border: '1px solid rgb(58, 145, 245)', background: 'none' }}>Back to Login</button> */}
                                </NavLink>
                            </div>
