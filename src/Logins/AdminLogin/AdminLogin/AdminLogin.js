    ...
    const loginuser = async (e) => {
        ...
        try {
            ...
            if (res.status === 200) {
                ...
                // Redirect to login page after cookie expiration
                // const expiresInMilliseconds = parseInt(expiryTime) * 60 * 1000;
                ...
                <div className="login-right col-6" style={{ textAlign: 'left', minHeight: '30vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', margin: ' 20%' }}>
                    ...
                    <div className="form-group col-12" >
                        ...
                        <div className='inputfield-container'>
                            <input value={inpval.email} onChange={setVal} name="email" id="email" style={{ padding: '8px 12px', width: '100%', border: "2px solid rgb(100, 149, 237)", borderRadius: '10px', }} />
                        </div>
                    ...
                    <div className="form-password col-12" style={{ marginBottom: '10px' }}>
                        <div className="password-input" style={{ display: 'flex', flexDirection: 'column', position: 'relative', marginTop: '3%' }}>
                            ...
                            {/* <InputField type={!passShow ? "password" : "text"} value={inpval.password} onChange={setVal} name="password" id="password" />
                            <div className="showpass" onClick={() => setPassShow(!passShow)} style={{ position: 'absolute', top: '70%', transform: 'translateY(-50%)', right: '20px', cursor: 'pointer' }}>
                                {!passShow ? <FaEyeSlash /> : <FaEye />}
                            </div> */}
                            <div className='inputfield-container'>
                                <input type={!passShow ? "password" : "text"} value={inpval.password} onChange={setVal} name="password" id="password" style={{ padding: '8px 12px', width: '100%', border: "2px solid rgb(100, 149, 237)", borderRadius: '10px', }} />
                                <div className="showpass" onClick={() => setPassShow(!passShow)} style={{ position: 'absolute', top: '75%', transform: 'translateY(-50%)', right: '20px', cursor: 'pointer' }}>
                                    {!passShow ? <FaEyeSlash /> : <FaEye />}
                                </div>
                            </div>
                        </div>
                    ...
                    <div style={{ textAlign: 'left', marginBottom: '3%', fontSize: '12px', }}>
                        <NavLink to="/forgotpass" href="#" style={{ color: 'rgb(100, 149, 237)', textDecoration: 'none' }}>Forgot Password?</NavLink>
                    </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', marginTop: '10px' }}>
                        ...
                        <label htmlFor="terms" style={{ color: '#696969', fontSize: '14px', marginBottom: '0' }}>"Agree to  <a href='"https://policies.google.com/terms?hl=en-US">Terms </NavLink> and <NavLink to="https://policies.google.com/terms?hl=en-US"' style={{ color: 'rgb(58, 145, 245)', textDecoration: 'none' }}>Conditions"</a></label>
                    </div>
                    ...
                    <div className="button-section col-12" style={{ display: 'flex', flexWrap: 'wrap', marginTop: '20px', textAlign: 'center' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                            <button onClick={loginuser} className='btn1 col-5'>Login</button>
                        </div>
                    ...
                    <div className="col-12" style={{ textAlign: 'center', marginTop: '20px', }}>
                        <h5> Don't have a PMS solutions client portal Account ? <NavLink to="/signup" style={{ color: 'rgb(100, 149, 237)', textDecoration: 'none' }}>Sign Up</NavLink></h5>
